...
<table>
    <tr>
        ...
        <td>
            ...
            <a href="https://www.python.org/"><img src="https://img.shields.io/badge/python-3.9%20%7C%203.14-blue.svg" alt="Python versions tested"></a>
            <a href="https://github.com/a1eko/treem/blob/master/LICENSE"><img src="https://img.shields.io/badge/License-MIT-brightgreen.svg" alt="License"></a>
        </td>
    </tr>
    <tr>
        <td>Platforms</td>
        <td>
            <img src="https://img.shields.io/badge/tested%20on-Linux-fcc624?style=flat&amp;logo=linux&amp;logoColor=white" alt="Tested on Linux">
            <img src="https://img.shields.io/badge/tested%20on-macOS-000000?style=flat&amp;logo=apple&amp;logoColor=white" alt="Tested on macOS">
            <img src="https://img.shields.io/badge/tested%20on-Windows-0078D4?style=flat&amp;logo=windows&amp;logoColor=white" alt="Tested on Windows">
        </td>
    </tr>
    <tr>
        <td>Development</td>
        <td>
            ...
            <a href="https://codecov.io/gh/a1eko/treem"><img src="https://codecov.io/gh/a1eko/treem/coverage.svg" alt="Code coverage"></a>
...
1. Download a sample neuron morphology in SWC file format:
   ```bash
   curl -O https://raw.githubusercontent.com/a1eko/treem/refs/heads/master/tests/data/pass_nmo_1.swc
   ```
...
no errors. Otherwise, convert the file to a compliant SWC format:
   ```bash
   swc convert pass_nmo_1.swc -o inp.swc
   ```

4. Inspect the reconstruction visually:
   ```bash
   swc view inp.swc
   ```

5. Find nodes with singularities within the reconstruction and visualize
them. Using the `swc find` command, you can search for nodes with small
...
the slice (within 30 micrometers of the extremes along z-axis):
   ```bash
...
apical dendrites in a Y-Z projection:
   ```bash
...
9. Compare the morphometry of all reconstructions:
   ```bash
   swc measure *.swc
   ```

10. Plot the original and modified reconstructions to a PDF file, adding 100-micrometer scale bars:
   ```bash
